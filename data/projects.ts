...
export const projects: Project[] = [
  ...
  },
  {
    ...
    featured: true,
    deviceType: "mobile",
    bgColor: "bg-linear-to-br from-amber-600/90 to-orange-600/90",
    screenshots: [
  ...
  },
  {
    ...
    featured: true,
    deviceType: "desktop",
    bgColor: "bg-linear-to-br from-red-600/90 to-orange-700/90",
    screenshots: [
  ...
  },
  {
    ...
    featured: true,
    deviceType: "mobile",
    bgColor: "bg-linear-to-br from-(--accent)/90 to-orange-600/90",
    screenshots: [
