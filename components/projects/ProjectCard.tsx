    ...
    >
          ...
          <div className="flex items-center gap-2 opacity-100 transition-opacity duration-300 xl:opacity-0 xl:group-hover:opacity-100">
            {project.github ? (
              <a
                ...
                className="inline-flex items-center gap-1.5 rounded-lg bg-linear-to-r from-orange-600 via-(--accent) to-red-600 px-2.5 py-1.5 text-[10px] font-semibold text-white transition-all duration-300 hover:shadow-lg hover:shadow-(--accent)/50 md:text-xs"
              >
                <FaGithub size={12} />
                GitHub
              </a>
      ...
      {project.demo ? (
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="relative block aspect-6/5 w-full rounded-[28px] border border-white/20 bg-[#161616] p-1 shadow-2xl ring-1 ring-white/10 transition-all duration-500 hover:scale-[1.01] hover:border-white/30"
        >
          ...
          <div className="absolute inset-0 z-50 rounded-[28px] transition-all group-hover:bg-white/5" />
        </a>
      ) : (
